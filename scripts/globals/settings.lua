...
xi.settings =
{
    ...
    WEAPON_SKILL_POINTS = 25.000, -- Multiplies points earned during weapon unlocking. (Not Implemented)
    ...
    ALL_ITEMS_STACKABLE_99               = 1, -- Allows all stackable items to be stacked to 99
}