    ...
    elseif (nation == xi.nation.BASTOK) then
        if (csid == 1001 and option ~= 1073741824 and option ~= 31) then
            ...
            timeline =
            {
                 ...
                 2, {1008, 0}, {0, 0}, {0, 0}, {0, 0}, {{4}, {11, 2}, {8, 10000}, {12}},                                             -- MISSION 1-3
                 ...
                 5, {714, 0}, {0, 0}, {0, 0}, {0, 0}, {{10, 35}, {6}, {13, 207}, {8, 30000}, {11, 3}, {9, 29}, {14, 0}, {12}},                 -- MISSION 2-3 (Finish (Naji))
                ...
                12, {38, 0}, {0, 0}, {0, 0}, {0, 0}, {{11, 4}, {14, 0}, {6}, {8, 50000}, {12}},                                         -- MISSION 3-3 (Finish (Goggehn))
                13, {35, 0}, {0, 0}, {0, 0}, {0, 0}, {{11, 5}, {14, 0}, {13, 212}, {10, 70}, {6}, {8, 100000}, {12}, {1, 14}},             -- MISSION 4-1 (Finish (Goggehn))
                14, {722, 0}, {0, 0}, {0, 0}, {0, 0}, {{14, 0}, {9, 73}, {5, 600}, {12}},                                             -- MISSION 5-1 (Finish (Naji))
                15, {603, 0}, {0, 0}, {0, 0}, {0, 0}, {{11, 6}, {14, 0}, {9, 74}, {8, 200000}, {6}, {12}},                                 -- MISSION 5-2 (Finish (Karst))
                16, {182, 0}, {0, 0}, {0, 0}, {0, 0}, {{14, 0}, {9, 266}, {5, 650}, {12}},                                             -- MISSION 6-1 (Finish (Tall Mountain))
                17, {762, 0}, {0, 0}, {0, 0}, {0, 0}, {{14, 0}, {6}, {11, 7}, {8, 400000}, {12}},                                     -- MISSION 6-2 (Finish (Naji))
                18, {764, 0}, {0, 0}, {0, 0}, {0, 0}, {{14, 0}, {9, 289}, {5, 700}, {12}},                                             -- MISSION 7-1 (Finish (Cid))
                19, {766, 0}, {0, 0}, {0, 0}, {0, 0}, {{14, 0}, {6}, {11, 8}, {8, 600000}, {3, "OptionalCSforOMW", 1}, {12}},             -- MISSION 7-2 (Finish (Karst))
                20, {768, 0}, {0, 0}, {0, 0}, {0, 0}, {{14, 0}, {5, 1133}, {12}},                                                 -- MISSION 8-1 (Finish (Iron Eater))
                21, {176, 0}, {0, 0}, {0, 0}, {0, 0}, {{14, 0}, {6}, {11, 9}, {9, 293}, {8, 800000}, {12}},                                     -- MISSION 8-2 (Finish (Bastok Mines))
            }
        end
    elseif (nation == xi.nation.WINDURST) then
        ...
        if (csid == guardlist[guard] and option ~= 1073741824 and option ~= 31) then
            ...
            timeline =
            {
                 ...
                 2, {154, 0}, {148, 0}, {114, 0}, {116, 0}, {{11, 2}, {14, 0}, {5, 300}, {8, 10000}, {12}},                     -- MISSION 1-3
                 ...
                 5, {101, 0}, {0, 0},     {0, 0},        {0, 0},       {{10, 35}, {6}, {13, 207}, {8, 30000}, {11, 3}, {9, 29}, {14, 0}, {12}}, -- MISSION 2-3 (Finish (Kupipi))
                ...
                12, {40, 0}, {0, 0},     {0, 0},        {0, 0},       {{11, 4}, {9, 30}, {14, 0}, {6}, {8, 50000}, {12}},                 -- MISSION 3-3 (Finish (Ambassador's door))
                13, {37, 0}, {0, 0},     {0, 0},        {0, 0},       {{11, 5}, {14, 0}, {13, 212}, {10, 71}, {6}, {8, 100000}, {12}},     -- MISSION 4-1 (Finish (Pakh Jatalfih))
                14, {192, 0}, {0, 0},     {0, 0},        {0, 0},       {{14, 0}, {9, 73}, {5, 600}, {12}},                             -- MISSION 5-1 (Finish (Star Sibyl))
                15, {216, 0}, {0, 0},     {0, 0},        {0, 0},       {{11, 6}, {14, 0}, {9, 74}, {8, 200000}, {6}, {12}},                 -- MISSION 5-2 (Finish (Star Sibyl))
                16, {0, 0},      {0, 0},     {50, 0}, {0, 0},       {{14, 0}, {5, 650}, {0, 0}, {0, 0}, {0, 0}, {12}},                    -- MISSION 6-1 (Finish (Zone: Full Moon Fountain))
                17, {0, 0},      {0, 0},     {312, 0}, {0, 0},       {{14, 0}, {11, 7}, {8, 400000}, {6}, {0, 0}, {12}},                -- MISSION 6-2 (Finish (Star Sibyl))
                18, {0, 0},      {0, 0},     {724, 0}, {0, 0},       {{14, 0}, {5, 700}, {9, 250}, {10, 251}, {0, 0}, {0, 0}, {12}},                -- MISSION 7-1 (Finish (Tosuka-Porika))
                19, {0, 0},      {0, 0},     {742, 0}, {0, 0},       {{14, 0}, {11, 8}, {8, 600000}, {6}, {0, 0}, {12}},                    -- MISSION 7-2 (Finish (Leepe-Hoppe))
                20, {0, 0},      {0, 0},     {758, 0}, {0, 0},       {{14, 0}, {5, 750}, {0, 0}, {0}, {0, 0}, {12}},                    -- MISSION 8-1 (Finish (Morno-Toeno))
                21, {0, 0},      {0, 0},     {609, 0}, {0, 0},       {{14, 0}, {11, 9}, {8, 800000}, {6}, {0, 0}, {12}},                    -- MISSION 8-2 (Finish (Apururu))
                22, {0, 0},     {0, 0},     {61, 0}, {0, 0},     {{14, 0}, {5, 800}, {13, 293}, {0}, {0, 0}, {12}},                    -- MISSION 9-1 (Finish (Zone: Full Moon Fountain))
                23, {0, 0},      {0, 0},     {407, 0}, {0, 0},       {{13, 294}, {11, 10}, {8, 1000000}, {6}, {0, 0}, {12}}                    -- MISSION 9-2 (Finish (Vestal Chamber))
            }
        end
    end
